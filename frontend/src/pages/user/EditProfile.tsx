...
import { getEditProfile, updateUserProfile } from "../../services/user/profileService";
...
const EditProfilePage = () => {
  ...
  const [user, setUser] = useState<UserProfile>({
    ...
    email: "",
    phone: "",
    addresses: [{ addressLine1: "", addressLine2: "", location: "", pincode: "", district: "", state: "" }],
  });
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (["addressLine1", "addressLine2", "location", "pincode", "district", "state"].includes(name)) {
      setUser((prevUser) => ({
        ...prevUser,
