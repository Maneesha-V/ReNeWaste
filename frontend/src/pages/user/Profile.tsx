        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center">
            ...
            <span className="text-gray-900">
              {user.addresses?.[0] ? `${user.addresses[0].addressLine1}, ${user.addresses[0].addressLine2}, ${user.addresses[0].location}, ${user.addresses[0].state}, ${user.addresses[0].pincode}, ${user.addresses[0].district}` : "No address available"}
            </span>
          </div>
        </div>
      </div>
