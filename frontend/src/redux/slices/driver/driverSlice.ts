...
import {
  ...
  sendOtpService,
  verifyOtpService,
} from "../../../services/driver/authService";
...
>("driver/login", async (driverData: LoginRequest, { rejectWithValue }) => {
  try {
...
export const driverLogout = createAsyncThunk<
  ...
  void,
  { rejectValue: { message: string } }
>("driver/logout", async (_, { rejectWithValue }) => {
  try {
    await logoutDriver();
    return null;
  } catch (error) {
...
export const sendOtp = createAsyncThunk<
  ...
  string,
  { rejectValue: { message: string } }
>("driver/sendOtp", async (email: string, { rejectWithValue }) => {
  try {
...
export const resendOtp = createAsyncThunk<
  ...
  string,
  { rejectValue: { message: string } }
>("driver/resendOtp", async (email: string, { rejectWithValue }) => {
  try {
