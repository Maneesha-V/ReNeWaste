...
import { getDriverDashboard, getWastePlantSupport } from "../../../services/driver/dashboardService";
import { DashboardSummary, DriverSupportInfo } from "../../../types/driver/driverTypes";
...
>(
  "driverDashboard/fetchDriverDashboard",
...
{ rejectValue : {message: string}}
>(
  "driverDashboard/fetchWastePlantSupport",
  async (_, { rejectWithValue }) => {
    try {
