...
let NotificationController = class NotificationController {
    ...
    async fetchNotifications(req, res, next) {
        try {
            ...
            res.status(constantUtils_1.STATUS_CODES.SUCCESS).json(notifications);
        }
        catch (error) {
    ...
    async markReadNotification(req, res, next) {
        try {
            ...
            res.status(constantUtils_1.STATUS_CODES.SUCCESS).json(updatedNotification);
        }
        catch (error) {
...
exports.NotificationController = NotificationController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(types_1.default.UserNotificationService)),
