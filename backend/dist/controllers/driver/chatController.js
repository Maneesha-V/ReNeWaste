...
let ChatController = class ChatController {
    ...
    async getConversationId(req, res, next) {
        try {
            ...
            const conversationId = await this.chatService.getOrCreateConversationId(senderId, senderRole, receiverId, receiverRole);
...
exports.ChatController = ChatController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(types_1.default.DriverChatService)),
