...
let WalletController = class WalletController {
    ...
    async getWallet(req, res, next) {
        try {
            ...
            const { transactions, balance, total, earnings } = await this._walletService.getWallet(accountId, accountType, page, limit, search);
...
exports.WalletController = WalletController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(types_1.default.PlantWalletService)),
