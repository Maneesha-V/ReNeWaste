...
import { FetchSubscriptionPlansResp, SubsptnPlansDTO, updateSubscptnReq } from "../../../dtos/subscription/subscptnPlanDTO";
...
export interface ISubscriptionService {
    ...
    fetchSubscriptionPlans(data: PaginationInput): Promise<FetchSubscriptionPlansResp>;
    ...
    updateSubscriptionPlanById({id, data}: updateSubscptnReq): Promise<SubsptnPlansDTO>;
}