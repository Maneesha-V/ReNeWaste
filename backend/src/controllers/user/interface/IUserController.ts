...
export interface IUserController {
  ...
  sendOtpForSignup(req: Request, res: Response, next: NextFunction): Promise<void>;
  resendOtpForSignup(req: Request, res: Response, next: NextFunction): Promise<void>;
  verifyOtpForSignup(req: Request, res: Response, next: NextFunction): Promise<void>;
