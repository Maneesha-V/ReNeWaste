...
export interface IPickupController {
    ...
    reschedulePickup(req: Request, res: Response, next: NextFunction): Promise<void>;
    fetchDriversByPlace (req: AuthRequest, res: Response, next: NextFunction): Promise<void>;
}